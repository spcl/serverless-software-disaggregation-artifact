    ...
    if(mypid == 0) {
      ...
      if(!use_docker) {
        ...
        const char * argv[] = {
          ...
          "--device=/dev/infiniband/issm7",
          "--device=/dev/infiniband/umad7",
          "--device=/dev/infiniband/uverbs7",
          "--device=/dev/infiniband/rdma_cm",
          "--cap-add=IPC_LOCK",
          "--volume",
          "/scratch/mcopik/2022/serverless/softw_disagg/serverless-software-disaggregation-artifact/src/remote_memory/build_repo:/opt",
          //"/users/mcopik/projects/rdma/repo/build_repo2:/opt",
          // FIXME: make configurable
          "rdma-test",
          "/opt/bin/executor",
          "-a", client_addr.c_str(),
